...
func MustLoadJSONSchemaDraft04() *k8sspec.Schema {
...
func JSONSchemaDraft04() (*k8sspec.Schema, error) {
	b, err := Asset("jsonschema-draft-04.json")
	if err != nil {
		return nil, err
	}

	schema := new(k8sspec.Schema)
...
func MustLoadSwagger20Schema() *k8sspec.Schema {
	d, e := Swagger20Schema()
	if e != nil {
		panic(e)
	}
...
func Swagger20Schema() (*k8sspec.Schema, error) {
