...
func (r *schemaLoader) isCircular(ref *k8sspec.Ref, basePath string, parentRefs ...string) (foundCycle bool) {
...
func (r *schemaLoader) Resolve(ref *k8sspec.Ref, target interface{}, basePath string) error {
	return r.resolveRef(ref, target, basePath)
}

func (r *schemaLoader) resolveRef(ref *k8sspec.Ref, target interface{}, basePath string) error {
	...
	if (ref.IsRoot() || ref.HasFragmentOnly) && root == nil && basePath != "" {
		if baseRef, erb := k8sspec.NewRef(basePath); erb == nil {
...
func (r *schemaLoader) transitiveResolver(basePath string, ref k8sspec.Ref) *schemaLoader {
	if ref.IsRoot() || ref.HasFragmentOnly {
		return r
	}

	baseRef := k8sspec.MustCreateRef(basePath)
