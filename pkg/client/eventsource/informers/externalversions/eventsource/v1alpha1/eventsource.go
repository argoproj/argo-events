...
import (
	...
	v1alpha1 "github.com/argoproj/argo-events/pkg/client/eventsource/listers/eventsource/v1alpha1"
...
func (f *eventSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsourcev1alpha1.EventSource{}, f.defaultInformer)
}
