		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"atLeastOnce": {
						SchemaProps: spec.SchemaProps{
							Description: "AtLeastOnce determines the trigger execution semantics Defaults to false. Trigger execution will use AtMostOnce semantics If set to true, Trigger execution will switch to AtLeastOnce semantics",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
