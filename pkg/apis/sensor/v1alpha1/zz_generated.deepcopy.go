...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoggingField) DeepCopyInto(out *LoggingField) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoggingField.
func (in *LoggingField) DeepCopy() *LoggingField {
	if in == nil {
		return nil
	}
	out := new(LoggingField)
	in.DeepCopyInto(out)
	return out
}
