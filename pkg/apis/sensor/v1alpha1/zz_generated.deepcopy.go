...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerPolicyCriteria) DeepCopyInto(out *TriggerPolicyCriteria) {
	*out = *in
	if in.Success != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerPolicyCriteria.
func (in *TriggerPolicyCriteria) DeepCopy() *TriggerPolicyCriteria {
	if in == nil {
		return nil
	}
	out := new(TriggerPolicyCriteria)
