...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceArtifact) DeepCopyInto(out *ResourceArtifact) {
	*out = *in
	if in.Data != nil {
		in, out := &in.Data, &out.Data
		*out = make([]byte, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceArtifact.
func (in *ResourceArtifact) DeepCopy() *ResourceArtifact {
	if in == nil {
		return nil
	}
	out := new(ResourceArtifact)
