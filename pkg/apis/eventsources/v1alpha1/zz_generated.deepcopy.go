...
func (in *StorageGridEventSource) DeepCopyInto(out *StorageGridEventSource) {
	*out = *in
	...
	if in.Notification != nil {
		...
		*out = new(StorageGridNotificationConfig)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageGridNotificationConfig) DeepCopyInto(out *StorageGridNotificationConfig) {
	*out = *in
	if in.AuthToken != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageGridNotificationConfig.
func (in *StorageGridNotificationConfig) DeepCopy() *StorageGridNotificationConfig {
	if in == nil {
		return nil
	}
	out := new(StorageGridNotificationConfig)
