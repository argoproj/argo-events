...
func (in *DispatchProtocol) DeepCopyInto(out *DispatchProtocol) {
	*out = *in
	out.Http = in.Http
	out.Nats = in.Nats
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DispatchProtocol.
func (in *DispatchProtocol) DeepCopy() *DispatchProtocol {
	if in == nil {
		return nil
	}
	out := new(DispatchProtocol)
	in.DeepCopyInto(out)
	return out
}
