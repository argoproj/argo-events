...
func (in *GithubEventSource) DeepCopyInto(out *GithubEventSource) {
	*out = *in
	...
	out.PayloadEnrichment = in.PayloadEnrichment
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PayloadEnrichmentFlags) DeepCopyInto(out *PayloadEnrichmentFlags) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PayloadEnrichmentFlags.
func (in *PayloadEnrichmentFlags) DeepCopy() *PayloadEnrichmentFlags {
	if in == nil {
		return nil
	}
	out := new(PayloadEnrichmentFlags)
	in.DeepCopyInto(out)
	return out
}
