...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HDFSClientConfig) DeepCopyInto(out *HDFSClientConfig) {
	*out = *in
	if in.Addresses != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HDFSClientConfig.
func (in *HDFSClientConfig) DeepCopy() *HDFSClientConfig {
	if in == nil {
		return nil
	}
	out := new(HDFSClientConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HDFSEventSource) DeepCopyInto(out *HDFSEventSource) {
	*out = *in
	out.WatchPathConfig = in.WatchPathConfig
	in.HDFSClientConfig.DeepCopyInto(&out.HDFSClientConfig)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NATSEventSource) DeepCopyInto(out *NATSEventSource) {
	*out = *in
	if in.Backoff != nil {
		in, out := &in.Backoff, &out.Backoff
		*out = new(wait.Backoff)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NATSEventSource.
func (in *NATSEventSource) DeepCopy() *NATSEventSource {
	if in == nil {
		return nil
	}
	out := new(NATSEventSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Source) DeepCopyInto(out *Source) {
	*out = *in
	...
	if in.Nats != nil {
		...
		*out = make(map[string]NATSEventSource, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
