...
func (in *EventSourceSpec) DeepCopyInto(out *EventSourceSpec) {
	*out = *in
	...
	if in.IMAP != nil {
		...
		*out = make(map[string]IMAPEventSource, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IMAPEventSource) DeepCopyInto(out *IMAPEventSource) {
	*out = *in
	if in.Username != nil {
		in, out := &in.Username, &out.Username
		*out = new(v1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IMAPEventSource.
func (in *IMAPEventSource) DeepCopy() *IMAPEventSource {
	if in == nil {
		return nil
	}
	out := new(IMAPEventSource)
	in.DeepCopyInto(out)
	return out
}
