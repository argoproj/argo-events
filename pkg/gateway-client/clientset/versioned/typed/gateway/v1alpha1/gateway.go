...
import (
	...
	scheme "github.com/argoproj/argo-events/pkg/gateway-client/clientset/versioned/scheme"
...
func newGateways(c *ArgoprojV1alpha1Client, namespace string) *gateways {
	return &gateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
