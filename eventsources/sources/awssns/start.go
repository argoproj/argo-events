...
func (router *Router) PostActivate() error {
	...
	awsSession, err := commonaws.CreateAWSSessionWithCredsInEnv(snsEventSource.Region, snsEventSource.RoleARN, snsEventSource.AccessKey, snsEventSource.SecretKey)
	if err != nil {
		return err
	}
