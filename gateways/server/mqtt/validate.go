...
func (listener *EventListener) ValidateEventSource(ctx context.Context, eventSource *gateways.EventSource) (*gateways.ValidEventSource, error) {
	if gatewayv1alpha1.EventSourceType(eventSource.Type) != gatewayv1alpha1.MQTTEvent {
		return &gateways.ValidEventSource{
			IsValid: false,
			Reason:  common.ErrEventSourceTypeMismatch(string(gatewayv1alpha1.MQTTEvent)),
		}, nil
	}
